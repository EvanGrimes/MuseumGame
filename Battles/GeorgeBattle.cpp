#include "GeorgeBattle.h"

void GeorgeBattle::tick() {
    frameCounter++;
    if(frameCounter >= 60){
        frameCounter = 0;
    }
...
void GeorgeBattle::render() {
    ClearBackground(BLACK);
    DrawTexture(Assets::GeorgeW, 370, 50, WHITE);
...
void GeorgeBattle::tickItem() {

}

void GeorgeBattle::tickLeave() {
...
void GeorgeBattle::DrawTextBox(const char *Message) {
