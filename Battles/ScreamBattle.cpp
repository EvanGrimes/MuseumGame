#include "ScreamBattle.h"

void ScreamBattle::tick() {
    frameCounter++;
    if(frameCounter >= 60){
        frameCounter = 0;
    }
...
void ScreamBattle::render() {
    ClearBackground(BLACK);
    DrawTexture(Assets::Scream, 370, 50, WHITE);
...
void ScreamBattle::DrawTextBox(const char *Message) {
