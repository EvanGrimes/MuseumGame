#include "PipeBattle.h"

void PipeBattle::tick() {
    frameCounter++;
    if(frameCounter >= 60){
        frameCounter = 0;
    }
...
void PipeBattle::DrawTextBox(const char *Message) {
